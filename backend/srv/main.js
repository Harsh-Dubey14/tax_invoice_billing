...
module.exports = async function () {
  ...
  const fetchPricingElements = async (
    ...
    try {
      ...
      return {
        subtotal,igst,igstRate,cgst,cgstRate,sgst,sgstRate,ugst,dis,ugstRate,totalPacking,totalFreight,totalInsurance, roundOff,TotalAmount, totalDiscount, totalRoundOff,GrandTotal,taxable:TotalAmount+totalFreight+totalDiscount,
      };
    } catch (err) {
      console.error(
